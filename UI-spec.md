...
> 本文件將「目前產品已經怎麼運作」與「接下來可以怎麼改善」分開描述。第 1–14 節是現況，第 15 節才是與設計師討論的 UX 議題。
...
| 3 | 下載紀錄 | 可進入 | 查看成功下載、開啟檔案位置、套用或移除紀錄 |
| 4 | 介面設定 | 可進入 | 切換深色／淺色模式與五級全域字體 |
